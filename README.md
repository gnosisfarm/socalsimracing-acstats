ACStats is two components. A log watch python script and a python Web App.
...
After running AC server, run the log watch. It needs to be integratged with server start/stop for a cleaner, less touch activation.
